...
public class MemberController {
	...
	Member member = new Member(memberDto.getMemberLastname(), memberDto.getMemberFirstname(), memberDto.getMemberEmail(), memberDto.getMemberPassword(), memberDto.getMemberAddress(),
	        memberDto.getMemberCity(), memberDto.getMemberPostalCode(), memberDto.getMemberPhone());
    ...
    /*
     * @GetMapping("/getlist") public List<MemberDto> getMembers() {
     ...
     * 
     * for (Member member : members) { List<Integer> auhtorIds = new
     * ArrayList<Integer>();
     * 
